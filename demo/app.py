...
# Rimpicciolisco i modelli per vedere se funziona meglio
sam_model = SamModel.from_pretrained("facebook/sam-vit-huge").to(device) # versione originale
sam_processor = SamProcessor.from_pretrained("facebook/sam-vit-huge") # versione originale
#sam_model = SamModel.from_pretrained("facebook/sam-vit-base").to(device)  # Base invece di Huge
